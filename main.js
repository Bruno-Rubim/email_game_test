...
let scale = Math.floor(maxHeight / 256);
let canvasWidth = 352 * scale;
let canvasHeight = 256 * scale;
...
const email_2 = new Email({
  picture: "default_picture_2",
  content: `Hey there,\nWe're excited to announce that KaneAI, our GenAI-native testing agent, is now live on Product Hunt!\n\nSince the KaneAI beta launch, the response has been incredible. Your feedback has been instrumental in shaping KaneAI into the AI testing solution it is today, one that truly democratizes test automation for teams everywhere.\n\n\nExperience AI-native testing like never before\nKaneAI transforms how you approach test automation. Just tell it what to test in natural language, and watch as it:\n\nIntelligently plan your entire test strategy\nAuthor robust end-to-end tests\nContinuously adapts as your application\nevolves\n\nSkip the technical complexity - no coding, no frameworks, no headaches. \n\nReady to experience AI-native testing? Try KaneAI today and see the future of test automation in action.\n\nVisit KaneAI on Product Hunt\n\nYour support and feedback on Product Hunt would mean the world to us. Thank you for being part of this journey!\n\nBest regards,\nThe LambdaTest Team​​​​​​`,
});

const email_3 = new Email({
  picture: "default_picture_3",
  content: `Welcome to Netlify Free!\nYour new team bruno-rubim924’s team is ready!\n\nWelcome to Netlify Free! You now have access to powerful tools to deploy and manage your web projects, including a global edge network, instant rollbacks, and live project previews with collaboration UI. Your plan includes 300 credits per month, giving you everything you need to get started.\n\nUnlike paid plans, the Free tier won’t accumulate overages—if you reach your credit limits, your projects will be disabled to prevent unexpected charges. You can always upgrade or add resources as needed.\n\nFor a detailed overview of our plans, visit our pricing page.\n\n\nGo to Dashboard\n`,
});

const email_4 = new Email({
  picture: "default_picture_4",
  content: `Você foi convidado a assinar um modelo de documento.\nClique aqui para assinar`,
});

const emailList = [email_1, email_2, email_3, email_4];

const emailObjects = [emailBackground, emailUI, email_1, appBorder, exitBtn];

training.onClick = () => {
  emailObjects[2] = emailList[randomInt(0, 3)];
